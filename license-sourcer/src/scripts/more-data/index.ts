    ...
    for (const license of licenses) {
        ...
        while (true) {
            ...
            for (const document of documents) {
                ...
                console.log(
                    `Processed ${componentsProcessed} components and ${licensesProcessed}/${licenses.length} licenses`
                );
